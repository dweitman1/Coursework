...
/*
    ...
    Description: Testing program for the ListCollection class.
*/

int main()
{
    ListCollection<double> l1;
   ...
   // l1 = l1.sort();
    ...
    ListCollection<double> l2 = l1.sublist(1, 6);
    l2.displayList();
    ...
    ListCollection<double> l3 = l1.sublist(4);
    l3.displayList();
