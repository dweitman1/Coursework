...
using namespace std;
//Default constructor for IntegerList object
...
{
    cout << "In + Operator Overload" << endl;
  ...
  return l;
  cout << "Out + Operator Overload" << endl;
}
...
{
    cout << "In [] Operator Overload: Calling parameter[" << x << "]" << endl;
  if(x < 0)//return first.
    return list[0];
